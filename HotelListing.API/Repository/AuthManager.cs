...
namespace HotelListing.API.Repository
{
    public class AuthManager : IAuthManager
    {
        ...
        public AuthManager(IConfiguration configuration, IMapper mapper, UserManager<ApiUser> userManager)
        {
        ...
        public async Task<AuthReponseDto> VerifyRefreshToken(AuthReponseDto request)
        {
